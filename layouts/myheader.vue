    ...
    <div class="wrapper">
      ...
      <div class="right-wrapper">
        ...
        <el-dropdown v-if="name != ''" @command="loginMenu">
         <span class="el-dropdown-link" v-if="headimgurl != null">
            <img style="width: 50px;border-radius:25px;" width="50" height="50" :src="headimgurl" />
          </span>
        <span class="el-dropdown-link" v-if="headimgurl == null">
            {{ name }}
    ...
    methods: {
      ...
      login() {
        ...
        userInfoApi
          ...
          .then(response => {
            ...
            //登录成功，设置token
            this.setCookies(response.data.token, response.data.name);
          })
          .catch(e => {
            this.dialogAtrr.loginBtn = "马上登录";
          });
      ...
      showInfo() {
        ...
        if (token) {
          ...
          //获得头像
          userInfoApi.getHeadimgurl(this.name)
          .then(response => {
