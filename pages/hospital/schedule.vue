  ...
  export default {
    ...
    methods: {
      ...
      getBookingScheduleRule() {
        hospitalApi.getBookingSchedule(this.page, this.limit, this.hoscode, this.depcode)
          .then(response => {
      ...
      //获取排班数据
      findScheduleList() {
        hospitalApi.findScheduleList(this.hoscode, this.depcode, this.workDate)
          .then(response => {
